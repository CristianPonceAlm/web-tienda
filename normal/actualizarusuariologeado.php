...
//Hacemos la query para modificar los datos
    $actualizar= "UPDATE `clientes` SET email='$newemail', nombrecliente='$newnombre' , apellidocliente='$newapellido', contrasena='$newcontrasena', direccion='$newdireccion', tipo='Normal' where email='$newemail'";
