...
<html>
    <head>
        ...
        <script language="JavaScript">
            function confirmar(){
                var respuesta= confirm("¿Quieres confirmar los cambios?");
                if(respuesta== true){
                    return true;
                }else{
                    return false;
    ...
    <body>
        <?php
           ...
           // Empezaremos estableciendo una conexion con el servidor de bases de datos usando PDO
            ...
            //Recogemos el email para saber que email estamos editando
                $emaileditando=$_POST['useremail'];
        ...
        <div id="masventas" >
            ...
            <form method="POST" action="actualizarusuariologeado.php"> <br>
                <?php
                    while($cliente=$consultacliente->fetchObject()){
                    ?>
                        <p> Email: <input type="text" name="cambiaremail" value="<?= $cliente->email ?>"> </p>
                        <p> Nombre: <input type="text" name="cambiarnombre" value="<?= $cliente->nombrecliente ?>"> </p>
                        <p> Apellidos: <input type="text" name="cambiarapellido" value="<?= $cliente->apellidocliente ?>"> </p>
                        <p> Contraseña: <input type="password" name="cambiarcontrasena" value="<?= $cliente->contrasena ?>"> </p>
                        <p> Confirmar contraseña : <input type="password" name="cambiarcontrasena" value="<?= $cliente->contrasena ?>"> </p>
                        <p> Dirección: <input type="text" name="cambiardireccion" value="<?= $cliente->direccion ?>"> </p>
