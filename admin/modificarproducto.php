...
<html>
    ...
    <body>
        <?php
           ...
           // Empezaremos estableciendo una conexion con el servidor de bases de datos usando PDO
            ...
            //Recogemos el id para saber que disco vamos a editar
                ...
                $consultacd= $conexion->query("SELECT `id`,`nombre`,`precio`,`stock`,`numeroventas` FROM discos where `id`='$discoid'");
            //Mostramos el id del cd elegido para ver si funciona bien
                //echo "El codigo que estas editando es el: $discoid";
        ...
        <div id="masventas" >
            ...
            <form method="POST" action="actualizarproducto.php"> <br>
                <?php
                    while($producto=$consultacd->fetchObject()){
                    ?>
                        <p> ID del disco: <input type="number" name="iddisco" value="<?= $producto->id ?>"> </p>
                        <p>Nombre del disco: <input type="text" name="nombredisco" value="<?= $producto->nombre ?>"> </p>
                        <p>Precio del disco: <input type="number" name="preciodisco" value="<?= $producto->precio ?>"> </p>
                        <p>Stock del disco: <input type="number" name="stockdisco" value="<?= $producto->stock ?>"> </p>
                        <p>Numero de ventas: <input type="number" name="ventasdisco" value="<?= $producto->numeroventas ?>"> </p>
            ...
            <form method="post" action="editproduct.php">
                ...
                ?>
            <!-- Ahora en el siguiente fichero "Actualizar.php haremos los updates--> 
             <br><br>
        </div>
